...
function help() {
  process.stderr.write(
    "Usage: npx --allow-git=all github:AIDDbot/AIDDbot init [--dry-run] [--force]\nCopies AIDDbot skills and harness adapters into the current directory. Existing files are left alone unless they match (skipped) or you pass --force.\nFor a workshop monorepo, run bin/scaffold.js instead.\n"
  );
}
...
const conflicts = runOverlay(destRoot, parsed.opts);
