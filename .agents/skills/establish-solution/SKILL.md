---
name: establish-solution
description: Establish a brownfield or greenfield solution ready for requirement delivery.
metadata:
...
Your goal is to establish a solution from repository evidence.
...
Never scaffold over substantive files, unresolved conflicts, or unrelated changes. The result is an established solution ready for requirement delivery.
