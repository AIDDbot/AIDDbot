...
Run `node .agents/skills/explore/scripts/initialize-product-docs.mjs --product-folder "{Product_Folder}"` to create missing counters, PRD, and TDR from the exact empty templates. Never replace existing product documents.
