...
- _SPAWN_ an _Architect_ agent to:
  -  read the PRD, relevant container rules, and current findings; 
  - reserve the spec ID and any requirement IDs in `counters.yaml`; 
  - define one small scope and type; create its branch; 
  - and execute [specify-spec](../specify-spec/SKILL.md).
