...
Without running quality tools, add still-present minor qualification findings to `TDR.md` and remove declared D IDs whose resolution the evidence proves. Reserve new D IDs from `counters.yaml` and never reuse them.
