...
13. Install all scaffold dependencies by following each project's documentation. Then run only each project's basic lint command at its default error threshold. Do not run tests, warning-denial modes, quality analysis, or automatic fixes. Report a failed installation or lint without repairing it.
