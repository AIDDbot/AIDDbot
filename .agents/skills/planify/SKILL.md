...
Write only `{Product_Folder}/specs/{spec_key}/{container}.plan.md`. The caller owns the aggregate spec status after every required plan exists. Do not update the PRD or sibling plans.
