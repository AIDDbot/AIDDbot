...
- Spawn a new **Architect** sub-agent to run the [`/specify`](/.agents/skills/specify/SKILL.md) skill with `kind: technical` to write a new specification for the solution architecture.
