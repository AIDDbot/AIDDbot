...
`/refactor` cuando lo que quieres es auditar un contenedor y pagar su deuda acumulada.
...
refactorizar necesita pruebas en las que apoyarse—, y después `/refactor` audita un contenedor y
...
código o de prueba vuelve por `/codify` hasta que está en verde. Después `/review` califica, y ahí
