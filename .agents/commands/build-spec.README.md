...
entry doors: `/specify` when you bring a functional requirement, and `/restructure` when you want a
...
refactoring needs passing tests to lean on — and then `/restructure` audits one container and captures
