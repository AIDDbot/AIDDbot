...
| **review** | → hallazgos de **comportamiento** reingresan a `/specify` | ← código en alcance, `{container}.rules.md`, definiciones de compuertas<br>→ `qualify.report.md` (veredicto por compuerta, hallazgos); en una spec no funcional, también veredicto y casilla por criterio |
