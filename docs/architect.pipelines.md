...
`/explore` and `/extract` use the [incremental artifact pattern](../.agents/skills/shared/incremental-artifact.md) — one file per run, `docs` commits. When complete, start features with `/specify`.
